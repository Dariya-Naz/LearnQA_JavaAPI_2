...
public class UserAuthTest {
    ...
    public void testAuthUser(){
        HashMap<Object, Object> authData = new HashMap<>();
        authData.put("email", "vinkotov@example.com");
        authData.put("login", "1234");
        ...
        assertTrue(responseGetAuth.jsonPath().getInt("user_id") > 0, "user_id should be greater than zero");
        ...
        assertEquals(
                userIdOnAuth,
                userIdOnCheck,
                "user id from auth request is noy equal to user_id from check request"
        );
    }
    @ParameterizedTest
